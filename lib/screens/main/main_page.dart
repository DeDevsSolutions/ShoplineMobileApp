...
import 'package:shopline/screens/notifications/notifications_empty.dart';
import 'package:shopline/screens/notifications/notifications_full.dart';
...
class _MainPageState extends State<MainPage>
  ...
  Widget build(BuildContext context) {
    Widget appBar = AppBar(
      actions: [
        IconButton(
          icon: Icon(TablerIcons.shopping_cart, color: Colors.indigo),
